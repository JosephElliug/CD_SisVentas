...
namespace CapaPresentacion
{
    public partial class FrmVenta : Form
    {
        ...
        private void CrearTablaDetalle()
        {
            ...
            dataListadoDetalle.Columns["iddetalle_ingreso"].HeaderText = "Número Venta";
            dataListadoDetalle.Columns["precio_venta"].DefaultCellStyle.Format = "N2";
            dataListadoDetalle.Columns["subtotal"].DefaultCellStyle.Format = "N2";
            dataListadoDetalle.Columns["descuento"].DefaultCellStyle.Format = "N2";
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Utilidades.MensajeError("Falta ingresar algunos datos.");
                    errorIcono.SetError(txtStockActual, "Ingrese un valor");
                }
